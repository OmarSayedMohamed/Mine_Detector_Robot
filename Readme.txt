...
Introduction
------------
Interfacing an ultrasonic sensor, mine sensor to detect the mines and the distance to objects in(cm) and displaying on 2x16 LCD using ATmega32 with the AVR toolchain.
...
Support
------
Please feel free to contact me if you have any questions/concerns. My email address is os20180533@gmail.com
